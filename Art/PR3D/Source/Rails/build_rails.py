...
def build(repo_root):
    ...
    evidence_dir = unity_dir / "Evidence"
    for d in (source_dir, export_dir, unity_dir, evidence_dir):
    ...
    scene["source_place_evidence"] = (
        "ProductionLine_Belt first 11 Place spacing sampled 0.358-0.490m; "
        "kit nominal 0.48m"
    )
    ...
    scene.render.filepath = str(evidence_dir / "PR3D_004_RailKit.png")
    ...
    contract = {
        ...
        "production_line_place_sample_m": {
            "prefab": "Assets/_Projects/Prefabs/ProductionLine/ProductionLine_Belt.prefab",
            "first_11_min_spacing": 0.358,
            "first_11_max_spacing": 0.490,
            "nominal_spacing": MODULE,
        },
        "anchors": {
